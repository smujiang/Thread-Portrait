...
n = int(input("insert number of points: "))
num_lineas = int(input("insert number of lines: "))
lista = [0, 0, ]
rad = 412 * 2 / 2 - 2
cx = 0
cy = 0
...
# img_dir = "H:\\Personal\\house\\images"
# original_img = "H:\\Personal\\house\\images.jpg"

img_dir = "/toy_data"
original_img = "/toy_data/images.jpg"

gray_scale_img = os.path.join(img_dir, "grande_gris.png")
...
ima = Image.open(original_img)

ima = ima.resize((412 * 3, 412 * 3))
ima = ima.convert('LA')
ima = ima.crop((412 * 3 / 6, 412 * 3 / 6, 5 * 412 * 3 / 6, 5 * 412 * 3 / 6))

ima.save(gray_scale_img)

img = Image.open(gray_scale_img).convert("RGB")
...
# Save with alpha
Image.fromarray(npImage).save(result_img)

img2 = Image.open(result_img)
